...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/bazel/overview).
...
```
docker pull cgr.dev/ORGANIZATION/bazel:latest
```
