...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/external-secrets/overview).
...
<!--overview:start-->
# Chainguard Image for external-secrets
...
```
docker pull cgr.dev/ORGANIZATION/external-secrets:latest
```
