...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/aws-load-balancer-controller/overview).
...
<!--overview:start-->
# Chainguard Image for aws-load-balancer-controller
...
```
docker pull cgr.dev/ORGANIZATION/aws-load-balancer-controller:latest
```
