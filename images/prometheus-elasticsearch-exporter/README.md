...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/prometheus-elasticsearch-exporter/overview).
...
<!--overview:start-->
# Chainguard Image for prometheus-elasticsearch-exporter
...
```
docker pull cgr.dev/ORGANIZATION/prometheus-elasticsearch-exporter:latest
```
