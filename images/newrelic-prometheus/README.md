...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/newrelic-prometheus/overview).
...
<!--overview:start-->
# Chainguard Image for newrelic-prometheus
...
```
docker pull cgr.dev/ORGANIZATION/newrelic-prometheus:latest
```
