...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/aws-for-fluent-bit/overview).
...
<!--overview:start-->
# Chainguard Image for aws-for-fluent-bit
...
```
docker pull cgr.dev/ORGANIZATION/aws-for-fluent-bit:latest
```
