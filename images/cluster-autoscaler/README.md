...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/cluster-autoscaler/overview).
...
<!--overview:start-->
# Chainguard Image for cluster-autoscaler
...
```
docker pull cgr.dev/ORGANIZATION/cluster-autoscaler:latest
```
