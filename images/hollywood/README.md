...
<!--overview:start-->
# Chainguard Container for hollywood

Container image for [Hollywood](https://github.com/dustinkirkland/hollywood), a fun terminal app that fills your console with Hollywood melodrama technobabble.
