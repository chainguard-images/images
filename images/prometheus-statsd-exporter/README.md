...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/prometheus-statsd-exporter/overview).
...
<!--overview:start-->
# Chainguard Image for prometheus-statsd-exporter
