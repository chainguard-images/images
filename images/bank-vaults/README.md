...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/bank-vaults/overview).
...
<!--overview:start-->
# Chainguard Image for bank-vaults
...
```
docker pull cgr.dev/ORGANIZATION/bank-vaults:latest
```
