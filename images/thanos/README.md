...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/thanos/overview).
...
```
docker pull cgr.dev/ORGANIZATION/thanos:latest
```
