...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/dex/overview).
...
```
docker pull cgr.dev/ORGANIZATION/dex:latest
```
