...
endoflife           = ""
console_summary     = ""
short_description   = "A minimal, Wolfi-based image for Spark Operator, which facilitates the deployment and management of Apache Spark applications in Kubernetes environments."
compatibility_notes = ""
