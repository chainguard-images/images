...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/crossplane-azure/overview).
...
<!--overview:start-->
# Chainguard Image for crossplane-azure
...
```
docker pull cgr.dev/ORGANIZATION/crossplane-azure:latest
```
