...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/pgbouncer/overview).
...
<!--overview:start-->
# Chainguard Image for pgbouncer
...
```
docker pull cgr.dev/ORGANIZATION/pgbouncer:latest
```
