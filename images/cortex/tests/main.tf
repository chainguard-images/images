...
resource "helm_release" "helm" {
  name             = "cortex-${random_pet.suffix.id}"
  namespace        = "cortex-${random_pet.suffix.id}"
  repository       = "https://cortexproject.github.io/cortex-helm-chart" // TODO
  chart            = "cortex-helm/cortex" // TODO
