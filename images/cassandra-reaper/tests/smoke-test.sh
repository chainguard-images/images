...
k8ssandra_operator_release_name=k8ssandra-operator-${RANDOM}
k8ssandra_operator_release_namespace=k8ssandra-operator-${RANDOM}

cert_manager_release_name=cert-manager-${RANDOM}
cert_manager_release_namespace=cert-manager-${RANDOM}
