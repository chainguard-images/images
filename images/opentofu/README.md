...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/opentofu/overview).
...
```
docker pull cgr.dev/ORGANIZATION/opentofu:latest
```
