...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/kubernetes-event-exporter/overview).
...
<!--overview:start-->
# Chainguard Image for kubernetes-event-exporter
...
```
docker pull cgr.dev/ORGANIZATION/kubernetes-event-exporter:latest
```
