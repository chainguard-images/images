...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/kubernetes-csi-external-provisioner/overview).
...
<!--overview:start-->
# Chainguard Image for kubernetes-csi-external-provisioner
...
```
docker pull cgr.dev/ORGANIZATION/kubernetes-csi-external-provisioner:latest
```
