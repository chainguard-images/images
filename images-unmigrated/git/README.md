...
| Tag | Digest | Arch |
| --- | ------ | ---- |
| `migration-root` `migration-root-2` `migration-root-2.38` `migration-root-2.38.1` `migration-root-2.38.1-r0` `migration-root-20221121` | `sha256:d55031771dadfcbe73d892a01075d24eb360c3eeeed82fd3d6b75f7a9d774412`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:d55031771dadfcbe73d892a01075d24eb360c3eeeed82fd3d6b75f7a9d774412) | `amd64` |
| `latest` | `sha256:790d5cfe393cab2e21478bb3ba25513d1f80e36114668ad04b50b37c417f8d9e`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:790d5cfe393cab2e21478bb3ba25513d1f80e36114668ad04b50b37c417f8d9e) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
| `2.38.1-r0` `root` | `sha256:b3f889b73d157638324255b78cb084c1db59c6f9ced0fbabda5d23e2cdfba280`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:b3f889b73d157638324255b78cb084c1db59c6f9ced0fbabda5d23e2cdfba280) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
| `migration-nonroot` `migration-nonroot-2` `migration-nonroot-2.38` `migration-nonroot-2.38.1` `migration-nonroot-2.38.1-r0` `migration-nonroot-20221121` | `sha256:80ee0d8a0d4d741eb0f3e9683410c6df77a13853d06039ecc106bb8cacb9b46a`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:80ee0d8a0d4d741eb0f3e9683410c6df77a13853d06039ecc106bb8cacb9b46a) | `amd64` |
...
| `2.38.1-r0-root-glibc` | `sha256:7e25b43de7b371314f92f9c67aa03923a8b27f299c22c68ed78da4c35d8f03db`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:7e25b43de7b371314f92f9c67aa03923a8b27f299c22c68ed78da4c35d8f03db) | `amd64` |
...
| `2.38.1-r0-glibc` | `sha256:68329e0e34c7a4fb0e866815ef724d04808edb4debaabef362c158f846084832`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:68329e0e34c7a4fb0e866815ef724d04808edb4debaabef362c158f846084832) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:790d5cfe393cab2e21478bb3ba25513d1f80e36114668ad04b50b37c417f8d9e"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "333fba326e4da293c0dbdaa2fd29c98ef5da107c",
      "1.3.6.1.4.1.57264.1.4": "Create Release",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/git",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIQCN3RPvrDKVvsDAkxNDa4x2bsNiYndMYBNvuqCQVGpuNwIgQX1bWa5PzOOJOgeoQe965MThjU5yK9RZbKdBJPq6Y+Q=",
        "Payload": {
          "body": "",
          "integratedTime": 1668996188,
          "logIndex": 7510704,
      ...
      "githubWorkflowSha": "333fba326e4da293c0dbdaa2fd29c98ef5da107c",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3510838398",
      "sha": "333fba326e4da293c0dbdaa2fd29c98ef5da107c"
    }
  }
]
```
