...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/nfs-subdir-external-provisioner/overview).
...
<!--overview:start-->
# Chainguard Image for nfs-subdir-external-provisioner
...
```
docker pull cgr.dev/ORGANIZATION/nfs-subdir-external-provisioner:latest
```
