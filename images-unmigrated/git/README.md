...
| `2.38.1-r0` `root` | `sha256:20ad24d6e4ca013b476402f9a6a3d6846fc6bba107c983baeedf4c4911eb65dd`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:20ad24d6e4ca013b476402f9a6a3d6846fc6bba107c983baeedf4c4911eb65dd) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
| `latest` | `sha256:ebad2aa912a189d8806eea4e6a2de7db9e1b2029c3c801ecd498f41adb857eda`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:ebad2aa912a189d8806eea4e6a2de7db9e1b2029c3c801ecd498f41adb857eda) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
| `migration-root` `migration-root-2` `migration-root-2.38` `migration-root-2.38.1` `migration-root-2.38.1-r0` `migration-root-20221128` | `sha256:ac352636dc16d9cc6b66e58dd08c26f21c711c9397ada9aa5b99096075e16f83`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:ac352636dc16d9cc6b66e58dd08c26f21c711c9397ada9aa5b99096075e16f83) | `amd64` |
...
| `2.38.1-r0-root-glibc` | `sha256:7e5a47c88d025de9d5def3908c9e67b19e60f0be589089a3666d418e5c73a498`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:7e5a47c88d025de9d5def3908c9e67b19e60f0be589089a3666d418e5c73a498) | `amd64` |
...
| `2.38.1-r0-glibc` | `sha256:0ef2080bbe304bc4b95011762f2cf29c1a244012a377c749502109acbb848f28`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:0ef2080bbe304bc4b95011762f2cf29c1a244012a377c749502109acbb848f28) | `amd64` |
| `migration-nonroot` `migration-nonroot-2` `migration-nonroot-2.38` `migration-nonroot-2.38.1` `migration-nonroot-2.38.1-r0` `migration-nonroot-20221128` | `sha256:193cc1bc5d7c2793a181553eba40f196dd67a30bfd3e3c94253284f14b818d3a`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:193cc1bc5d7c2793a181553eba40f196dd67a30bfd3e3c94253284f14b818d3a) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:ebad2aa912a189d8806eea4e6a2de7db9e1b2029c3c801ecd498f41adb857eda"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "ad49abe8945e6d4b986d09537ef157f508aefe28",
      "1.3.6.1.4.1.57264.1.4": "Create Release",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/git",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIBef90BEPPIo1CQ4yoD3KH132ix43H+zbkCxlviPrNZLAiEAg9j6h+LtIGMVmXnZZ2fBFrZHOYCjaXMwPJZi+dmnBoU=",
        "Payload": {
          "body": "",
          "integratedTime": 1669594984,
          "logIndex": 7977981,
      ...
      "githubWorkflowSha": "ad49abe8945e6d4b986d09537ef157f508aefe28",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3560649224",
      "sha": "ad49abe8945e6d4b986d09537ef157f508aefe28"
    }
  }
]
```
