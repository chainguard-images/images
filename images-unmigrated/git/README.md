...
| `migration-nonroot` `migration-nonroot-2` `migration-nonroot-2.38` `migration-nonroot-2.38.1` `migration-nonroot-2.38.1-r0` `migration-nonroot-20221126` | `sha256:6fdc5259621b17fd56dd3ecf6a8216fcad58771e810d44cd7806873440717c69`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:6fdc5259621b17fd56dd3ecf6a8216fcad58771e810d44cd7806873440717c69) | `amd64` |
| `migration-root` `migration-root-2` `migration-root-2.38` `migration-root-2.38.1` `migration-root-2.38.1-r0` `migration-root-20221126` | `sha256:f9e78c0b25739dcecec582484228898bc8863bf76823dff3e6aac8b4cebdb13a`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:f9e78c0b25739dcecec582484228898bc8863bf76823dff3e6aac8b4cebdb13a) | `amd64` |
...
| `latest` | `sha256:f270784994e140f67aa778611f79b32413b2a8c33443f30002cbb1281bab066e`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:f270784994e140f67aa778611f79b32413b2a8c33443f30002cbb1281bab066e) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
| `2.38.1-r0-root-glibc` | `sha256:4be983f558b19aacc85ccb1ac23e3ae7f1a6dfacba2940f88dca55fc35a7aba5`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:4be983f558b19aacc85ccb1ac23e3ae7f1a6dfacba2940f88dca55fc35a7aba5) | `amd64` |
...
| `2.38.1-r0` `root` | `sha256:58b9343862fba918803eae13a3ada87059937c3f6679559eb8b2b9807a4179e9`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:58b9343862fba918803eae13a3ada87059937c3f6679559eb8b2b9807a4179e9) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
| `2.38.1-r0-glibc` | `sha256:7f3e3a22ec22927b193044931130cb7294ead3a7a809ecb4f0634b286906b855`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:7f3e3a22ec22927b193044931130cb7294ead3a7a809ecb4f0634b286906b855) | `amd64` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:f270784994e140f67aa778611f79b32413b2a8c33443f30002cbb1281bab066e"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "5ed84cebe031582a19ff8f47237ce48aab419f5d",
      "1.3.6.1.4.1.57264.1.4": "Create Release",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/git",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIQDjrRYsspP6zG30hNRRD9TWR4e7pJv1sWPnuMSTttcHjwIgIF3mk1hWNiWFAjR44sK7ZLQkBb5NdmLbyLkvhMt9dNE=",
        "Payload": {
          "body": "",
          "integratedTime": 1669422168,
          "logIndex": 7857451,
      ...
      "githubWorkflowSha": "5ed84cebe031582a19ff8f47237ce48aab419f5d",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3551422670",
      "sha": "5ed84cebe031582a19ff8f47237ce48aab419f5d"
    }
  }
]
```
