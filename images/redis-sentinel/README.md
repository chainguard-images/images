...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/redis-sentinel/overview).
...
<!--overview:start-->
# Chainguard Image for redis-sentinel
...
```
docker pull cgr.dev/ORGANIZATION/redis-sentinel:latest
```
