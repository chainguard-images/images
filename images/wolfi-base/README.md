...
* [View container image in the Chainguard Containers Directory](https://images.chainguard.dev/directory/image/wolfi-base/versions) for a full list of available tags.
