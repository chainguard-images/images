...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/kubernetes-csi-external-resizer/overview).
...
<!--overview:start-->
# Chainguard Image for kubernetes-csi-external-resizer
...
```
docker pull cgr.dev/ORGANIZATION/kubernetes-csi-external-resizer:latest
```
