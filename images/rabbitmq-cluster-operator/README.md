...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/rabbitmq-cluster-operator/overview).
...
<!--overview:start-->
# Chainguard Image for rabbitmq-cluster-operator
...
```
docker pull cgr.dev/ORGANIZATION/rabbitmq-cluster-operator:latest
```
