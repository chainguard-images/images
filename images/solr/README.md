...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/solr/overview).
...
```
docker pull cgr.dev/ORGANIZATION/solr:latest
```
