...
| - | - |
| **Status** | experimental |
| **OCI Reference** | `cgr.dev/chainguard/cert-manager-controller` |


* [View Image in Chainguard Academy](https://edu.chainguard.dev/chainguard/chainguard-images/reference/cert-manager-controller/overview/)
