...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/loki/overview).
...
```
docker pull cgr.dev/ORGANIZATION/loki:latest
```
