...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/aws-cli/overview).
...
```
docker pull cgr.dev/ORGANIZATION/aws-cli:latest
```
