...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/atlantis/overview).
...
```
docker pull cgr.dev/ORGANIZATION/atlantis:latest
```
