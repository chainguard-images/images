...
| `migration-root` `migration-root-2` `migration-root-2.38` `migration-root-2.38.1` `migration-root-2.38.1-r0` `migration-root-20221122` | `sha256:53ebd35dcc87e035bbb1b95a53950212e1a0cf87fd64d705408c828609613bb5`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:53ebd35dcc87e035bbb1b95a53950212e1a0cf87fd64d705408c828609613bb5) | `amd64` |
...
| `latest` | `sha256:522c5a6fd619f8bca877e61dc9265e9105c543c55855c55376db5b49f4f44dfa`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:522c5a6fd619f8bca877e61dc9265e9105c543c55855c55376db5b49f4f44dfa) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
| `migration-nonroot` `migration-nonroot-2` `migration-nonroot-2.38` `migration-nonroot-2.38.1` `migration-nonroot-2.38.1-r0` `migration-nonroot-20221122` | `sha256:2e149960be4c1870d11a1c9fadd55fa519bf95066215c1dd923595ad9e1b5746`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:2e149960be4c1870d11a1c9fadd55fa519bf95066215c1dd923595ad9e1b5746) | `amd64` |
...
| `2.38.1-r0-glibc` | `sha256:f76cb519d901fb2c1f85f42ab9a780e62b2f4e1ec676ea6fec68996552f02cee`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:f76cb519d901fb2c1f85f42ab9a780e62b2f4e1ec676ea6fec68996552f02cee) | `amd64` |
| `2.38.1-r0-root-glibc` | `sha256:01b043956ce8c243dd451f187c38470327c17bc28038bac6901ebaed64c5f731`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:01b043956ce8c243dd451f187c38470327c17bc28038bac6901ebaed64c5f731) | `amd64` |
...
| `2.38.1-r0` `root` | `sha256:ea213d1c3921d8e8922258f668cc3aa763438fc873c8938bd09168f768d6d7a6`<br/>[View entry in Rekor](https://rekor.tlog.dev/?hash=sha256:ea213d1c3921d8e8922258f668cc3aa763438fc873c8938bd09168f768d6d7a6) | `386` `amd64` `arm64` `armv6` `armv7` `ppc64le` `riscv64` `s390x` |
...
[
  {
    "critical": {
      ...
      "image": {
        "docker-manifest-digest": "sha256:522c5a6fd619f8bca877e61dc9265e9105c543c55855c55376db5b49f4f44dfa"
      },
    ...
    "optional": {
      ...
      "1.3.6.1.4.1.57264.1.3": "118c48943514ca3557f8b4eaadd42bf176505f19",
      "1.3.6.1.4.1.57264.1.4": "Create Release",
      "1.3.6.1.4.1.57264.1.5": "chainguard-images/git",
      "1.3.6.1.4.1.57264.1.6": "refs/heads/main",
      "Bundle": {
        "SignedEntryTimestamp": "MEUCIQDfM+QSij7+tQp2htlZWp9XZn3TbtqAkcUkRBTktevdPAIgC+L/BFgsyGsub5fF1IJaY1WRpFayqJq+lRdz1GoaakU=",
        "Payload": {
          "body": "",
          "integratedTime": 1669076830,
          "logIndex": 7577103,
      ...
      "githubWorkflowSha": "118c48943514ca3557f8b4eaadd42bf176505f19",
      "githubWorkflowTrigger": "schedule",
      "run_attempt": "1",
      "run_id": "3519252130",
      "sha": "118c48943514ca3557f8b4eaadd42bf176505f19"
    }
  }
]
```
