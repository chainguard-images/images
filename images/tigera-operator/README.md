...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/tigera-operator/overview).
...
<!--overview:start-->
# Chainguard Image for tigera-operator
...
```
docker pull cgr.dev/ORGANIZATION/tigera-operator:latest
```
