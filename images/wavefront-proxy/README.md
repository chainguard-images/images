...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/wavefront-proxy/overview).
...
<!--overview:start-->
# Chainguard Image for wavefront-proxy
...
```
docker pull cgr.dev/ORGANIZATION/wavefront-proxy:latest
```
