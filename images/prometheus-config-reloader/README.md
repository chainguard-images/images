...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/prometheus-config-reloader/overview).
...
<!--overview:start-->
# Chainguard Image for prometheus-config-reloader
...
```
docker pull cgr.dev/ORGANIZATION/prometheus-config-reloader:latest
```
