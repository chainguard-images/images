...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/prometheus-adapter/overview).
...
<!--overview:start-->
# Chainguard Image for prometheus-adapter
...
```
docker pull cgr.dev/ORGANIZATION/prometheus-adapter:latest
```
