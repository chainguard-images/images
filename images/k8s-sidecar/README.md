...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/k8s-sidecar/overview).
...
<!--overview:start-->
# Chainguard Image for k8s-sidecar
...
```
docker pull cgr.dev/ORGANIZATION/k8s-sidecar:latest
```
