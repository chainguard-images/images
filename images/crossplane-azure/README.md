...
<!--url:start-->
<a href="https://github.com/crossplane-contrib/provider-azure">
<!--logo:start-->
  <img src="https://storage.googleapis.com/chainguard-academy/logos/crossplane-azure/logo.svg" width="36px" height="36px" />
<!--logo:end-->
</a>
<!--url:end-->
