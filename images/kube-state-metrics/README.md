...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/kube-state-metrics/overview).
...
<!--overview:start-->
# Chainguard Image for kube-state-metrics
...
```
docker pull cgr.dev/ORGANIZATION/kube-state-metrics:latest
```
