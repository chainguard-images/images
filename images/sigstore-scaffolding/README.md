...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/sigstore-scaffolding/overview).
...
<!--overview:start-->
# Chainguard Image for sigstore-scaffolding
...
```
docker pull cgr.dev/ORGANIZATION/sigstore-scaffolding:latest
```
