...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/memcached-exporter-bitnami/overview).
...
<!--overview:start-->
# Chainguard Image for memcached-exporter-bitnami
...
```
docker pull cgr.dev/ORGANIZATION/memcached-exporter-bitnami:latest
```
