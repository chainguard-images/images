...
* [View Image in the Chainguard Images Directory](https://images.chainguard.dev/directory/image/newrelic-prometheus-configurator/overview).
...
<!--overview:start-->
# Chainguard Image for newrelic-prometheus-configurator
...
```
docker pull cgr.dev/ORGANIZATION/newrelic-prometheus-configurator:latest
```
